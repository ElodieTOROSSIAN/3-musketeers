...
test('should return a Big number', () => {
	//expect(typeof convert(2, 'BTC', 'BTC', 'Big')).toBe('object');//pas sure
...
test('should not convert a NaN to a Big', () => {
	expect(typeof convert(NaN, 'BTC', 'BTC', 'Big')).toBe('object');
}); //should not convert a NaN to a Big
...
test('should throw when untest is undefined', () => { //NON
